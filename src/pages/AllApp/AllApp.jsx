    ...
    const appDatas = use(AppData)
        ...
        return (
          ...
          <div className="flex justify-between items-center mt-10 mb-4">
             <h1>({appDatas.length}) Apps Found</h1>
             ...
             <label className="input border-1 border-gray-400 bg-white ">
                ...
                <input className="grow focus:outline-none text-gray-700 focus:border-0" type="search" required placeholder="Search App" />
             </label>
         </div>
     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
    {
        appDatas.map((data,index) => 
